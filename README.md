...
```
402.fhe/contracts/    Solidity + Hardhat + fhEVM — FHE402Marketplace.sol
402.fhe/middleware/   Node.js / Express — fhe-402 payment handler + off-chain proof store
402.fhe/agent/        Python AI agent client demo
402.fhe/app/          Next.js frontend — marketplace, buyer, merchant, and operator views
```
